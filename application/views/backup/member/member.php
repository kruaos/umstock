...
<form method='post' action="memberAdd.php">
  ...
  <div class="form-row ">
    ...
    <tr>
      ...
      <a class="btn btn-primary btn-sm" href='memberEdit.php?memberid=<?php echo $cusid?>'>แก้ไข</a>
      <a class="btn btn-danger btn-sm" href='memberDel.php?cusid=<?php echo $cusid?>'>ลบ</a></td>
    </tr>  
      <?php
        }
     ?>
